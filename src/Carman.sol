...
contract CarMan is ERC721A, Ownable {
  ...
  */
  ...
  // 優化後的白名單判斷
  function isWhitelisted(bytes32[] calldata _proof,address _user) public view returns (bool){
    bool success = MerkleProof.verifyCalldata(_proof, merkleTreeRoot, keccak256(abi.encodePacked(_user)));
    return success;
  }
